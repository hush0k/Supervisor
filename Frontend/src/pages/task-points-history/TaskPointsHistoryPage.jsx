...
import { TaskPointsHistoryContent } from '@/pages/task-points-history/ui/TaskPointsHistoryContent.jsx'

export function TaskPointsHistoryPage() {
    return (
